...
class moderndancePage extends StatefulWidget {
  const moderndancePage({Key key}) : super(key: key);

  @override
  State<moderndancePage> createState() => _moderndancePageState();
}
...
class _moderndancePageState extends State<moderndancePage> {
  ...
  final List<String> images = [
    'assets/images/md1.jpeg',
    'assets/images/md2.jpeg',
    'assets/images/md3.jpeg',
  ];
  @override
                      ...
                      child: Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Modern Dance adalah suatu gerakan dengan pola dan struktur yang seirama dan diiringi oleh alunan musik. Modern dance, atau dalam Bahasa Indonesia berarti tari modern,adalah suatu bentuk tarian yang terbentuk dan berkembang sejak dari awal abad 20 (Horosko,2002.P.1)",
                                style: TextStyle(
